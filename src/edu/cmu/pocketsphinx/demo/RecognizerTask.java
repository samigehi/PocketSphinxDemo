...
public class RecognizerTask implements Runnable {
	 ...
	 * @author David Huggins-Daines <dhuggins@cs.cmu.edu>
	 */
	//ToggleButton btnSumit=(ToggleButton)android.app.Activity.findViewById(R.id.toggleButton1);
	...
	public boolean getUsePartials() {
		...
		//edu.cmu.pocketsphinx.demo.PocketSphinxDemo.sumit;
	public RecognizerTask() {
		
		//btnSumit=(ToggleButton)android.app.Activity..findViewById(R.id.toggleButton1);
		
		 //btnSumit
		//Config c = new Config();
		/*if (edu.cmu.pocketsphinx.demo.PocketSphinxDemo.sumit=true)
		 {
		...
		try{
		 ...
		 {
			 pocketsphinx.setLogfile("/sdcard/Android/data/edu.cmu.pocketsphinx/pocketsphinx_sumit.log");
 		c.setString("-hmm",
				"/sdcard/Android/data/edu.cmu.pocketsphinx/sumit/hmm");
		c.setString("-dict",
				"/sdcard/Android/data/edu.cmu.pocketsphinx/sumit/lm/hindi.dic");
		c.setString("-lm",
				"/sdcard/Android/data/edu.cmu.pocketsphinx/lm/en_US/hindi.DMP");
		return;
		 }*/
		
		pocketsphinx
				.setLogfile("/sdcard/Android/data/edu.cmu.pocketsphinx/pocketsphinx_sumit.log");
		Config c = new Config();
		/*
